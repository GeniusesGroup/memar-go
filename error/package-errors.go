...
// package errors
var (
	ErrNotFound = New("urn:giti:error.protocol:error:not-found").SetDetail(protocol.LanguageEnglish, domainEnglish, "Not Found",
		...
		SetDetail(protocol.LanguagePersian, domainPersian, "یافت نشد",
	...
	ErrIsEmpty = New("urn:giti:error.protocol:error:is-empty").SetDetail(protocol.LanguageEnglish, domainEnglish, "Is Empty",
		"Given Error is not exist",
		"Sorry it's us not your fault! Contact administrator of platform!",
		"Trace error by enable panic recovery to find nil error detection problem").
		SetDetail(protocol.LanguagePersian, domainPersian, "وجود ندارد",
	...
	ErrSDKNotFound = New("urn:giti:error.protocol:error:sdk-not-found").SetDetail(protocol.LanguageEnglish, domainEnglish, "SDK Not Found",
		...
		SetDetail(protocol.LanguagePersian, domainPersian, "بسته توسعه یافت نشد",
