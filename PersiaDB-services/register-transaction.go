...
var registerTransactionService = chaparkhane.Service{
	ID:              3840530512,
...
// Requester must send FinishTransaction() immediately, otherwise Transaction manager will drop this request from queue and chain!
func RegisterTransaction(s *chaparkhane.Server, st *chaparkhane.Stream) {}
...
func registerTransaction(st *chaparkhane.Stream, req *registerTransactionReq) (res *registerTransactionRes, err error) {
	return res, nil
}
